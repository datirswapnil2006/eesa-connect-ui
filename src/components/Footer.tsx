      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-sidebar-foreground/70 leading-relaxed">
              Electronic Engineering Students Association – Building the future
              of technology, one circuit at a time.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-sm text-sidebar-foreground/70">
                <Instagram className="w-4 h-4 text-sidebar-primary" />
                <a
              ...
              <li className="flex items-center gap-2 text-sm text-sidebar-foreground/70">
                <Linkedin className="w-4 h-4 text-sidebar-primary" />
                <a
                  ...
                  className="hover:text-sidebar-primary transition-colors"
                >
                  EESA – Electronics Engineering Student Association
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-sidebar-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link
              to="/privacy"
              className="text-sm text-sidebar-foreground/50 hover:text-sidebar-primary transition-colors"
            >
              Privacy Policy
            </Link>
            <Link
